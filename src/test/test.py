...
from src.models.SLT_model import SignLanguageTranslatorV2, SignLanguageTranslatorV1, SignLanguageTranslatorV4
...
MODEL_PATH     = os.path.join(SAVE_DIR, "v1_wlasl2000_26_08_09.pt")
...
def evaluate(model, loader, idx2gloss, top_k=5):
    ...
    with torch.no_grad():
        for features, hand_normalize_features, labels, video_mask in tqdm(loader, desc="Evaluating"):
